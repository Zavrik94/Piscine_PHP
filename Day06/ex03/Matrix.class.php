...
class Matrix {
    ...
    {
        $this->identity(1);
        $this->matrix[3] = $this->a['vtc']->getX();
        $this->matrix[7] = $this->a['vtc']->getY();
        $this->matrix[11] = $this->a['vtc']->getZ();
    }
    private function rotation_x()
    {
        $this->identity(1);
        $this->matrix[0] = 1;
        $this->matrix[5] = cos($this->a['angle']);
        $this->matrix[6] = -sin($this->a['angle']);
        $this->matrix[9] = sin($this->a['angle']);
        $this->matrix[10] = cos($this->a['angle']);
    }
    private function rotation_y()
    {
        $this->identity(1);
        $this->matrix[0] = cos($this->a['angle']);
        $this->matrix[2] = sin($this->a['angle']);
        $this->matrix[5] = 1;
        $this->matrix[8] = -sin($this->a['angle']);
        $this->matrix[10] = cos($this->a['angle']);
    }
    private function rotation_z()
    {
        $this->identity(1);
        $this->matrix[0] = cos($this->a['angle']);
        $this->matrix[1] = -sin($this->a['angle']);
        $this->matrix[4] = sin($this->a['angle']);
        $this->matrix[5] = cos($this->a['angle']);
        $this->matrix[10] = 1;
    }
    ...
    {
        $this->identity(1);
        $this->matrix[5] = 1 / tan(0.5 * deg2rad($this->a['fov']));
        $this->matrix[0] = $this->matrix[5] / $this->a['ratio'];
        $this->matrix[10] = -1 * (-$this->a['near'] - $this->a['far']) / ($this->a['near'] - $this->a['far']);
        $this->matrix[14] = -1;
        $this->matrix[11] = (2 * $this->a['near'] * $this->a['far']) / ($this->a['near'] - $this->a['far']);
        $this->matrix[15] = 0;
    }
