...
$('document').ready(function() {
    ...
    if (coo) {
        let i = coo.length - 1;
        for (i; i >= 0; i--) {
            $('#ft_list').append('<div name="' + coo[i][0] + '" class="elem" onclick="delete_task(this)">' + decodeURIComponent(coo[i][1]) + '</div>');
        }
    }
    ...
    $('#add').click(function () {
        ...
        if (todo_all) {
            ...
            $('#ft_list').prepend('<div class="elem" onclick="delete_task(this)">' + new_task_text + '</div>');
        }
